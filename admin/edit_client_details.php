...
if (isset($_SESSION['user'])) {
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <form class="" method="post" enctype="multipart/form-data" action="client_controller.php">
                <div class="row">
                    <div class="col-8">
                ...
                <button type="submit" class="btn btn-primary" name="edit_client_details">Submit</button>
            </form>
        </div>
    </div>
    </div>
