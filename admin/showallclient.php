            ...
            <tbody>
                ...
                for ($i = 0; $i < count($rows); $i++) {
                    ...
                    <tr>
                        ...
                        <td><a href="viewclientprofile.php?view=<?php echo $rows[$i]['id']; ?>"
                                class="btn btn-primary">View</a></td>
                        <td><a href="edit_client_details.php?edit=<?php echo $rows[$i]['id']; ?>"
                                class="btn btn-warning">Edit</a></td>
                        <td><a href="client_controller.php?del=<?php echo $rows[$i]['id']; ?>"
                                class="btn btn-danger">Delete</a></td>
                        <td>
                            <?php
                              $subscribe = "";
                            $subscribe = checkSubscription($rows[$i]['name']);
                            ?>
                            <a href="subscribe.php?id=<?php echo $rows[$i]['id']; ?>"
